...
A histogram is a visualization of the distribution of continuous (numerical) data. 
Histograms are a quick way to show if your data are skewed (right skew: longer right tail or left skew: longer left tail) or are symmetric. 

### Questions a histogram answers:  
