...
The distribution shows two peaks of data. This might occur because the data set contains two distinct groups. 
...
You can also manually hard code each of the variables. 
