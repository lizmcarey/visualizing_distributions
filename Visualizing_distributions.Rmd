...
The distribution shows two peaks of data. This might occur because the data set contains two distinct groups. Consider breaking your dataset into differnt groups to separate the peaks.   
